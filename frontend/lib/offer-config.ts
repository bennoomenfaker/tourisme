...
export const VENUE_TYPE_OFFERS: Record<string, string[]> = {
  accommodation: ['accommodation', 'restaurant', 'activity', 'sejour', 'transport', 'workshop', 'guide_service', 'equipment_rental', 'event', 'craft'],
  camping: ['accommodation', 'activity', 'equipment_rental', 'sejour', 'restaurant', 'transport', 'workshop', 'guide_service', 'event', 'craft'],
  restaurant: ['restaurant', 'event', 'craft', 'accommodation', 'activity', 'sejour', 'transport', 'workshop', 'guide_service', 'equipment_rental'],
  activity_center: ['activity', 'workshop', 'equipment_rental', 'event', 'accommodation', 'restaurant', 'sejour', 'transport', 'guide_service', 'craft'],
  artisan: ['workshop', 'event', 'equipment_rental', 'craft', 'accommodation', 'restaurant', 'activity', 'sejour', 'transport', 'guide_service'],
  farm: ['accommodation', 'restaurant', 'activity', 'workshop', 'sejour', 'eco_tour', 'transport', 'guide_service', 'equipment_rental', 'event', 'craft'],
  transport: ['transport', 'equipment_rental', 'circuit', 'accommodation', 'restaurant', 'activity', 'sejour', 'workshop', 'guide_service', 'event', 'craft'],
  event_space: ['event', 'accommodation', 'restaurant', 'workshop', 'activity', 'sejour', 'transport', 'guide_service', 'equipment_rental', 'craft'],
  tourism_association: ['activity', 'guide_service', 'workshop', 'transport', 'eco_tour', 'circuit', 'event', 'accommodation', 'restaurant', 'sejour', 'equipment_rental', 'craft'],
  eco_park: ['activity', 'accommodation', 'guide_service', 'equipment_rental', 'eco_tour', 'circuit', 'restaurant', 'sejour', 'transport', 'workshop', 'event', 'craft'],
};
