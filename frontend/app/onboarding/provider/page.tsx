    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1.5">
          ...
          <input
            type="tel"
            className="w-full px-4 py-3.5 bg-surface-container border-none rounded-xl focus:ring-2 focus:ring-primary text-slate-900 placeholder:text-slate-400 font-medium"
            value={data.whatsapp}
        ...
        <div className="space-y-1.5">
          <label className="text-sm font-bold text-slate-700 ml-1">Site web</label>
          <input
            type="url"
            className="w-full px-4 py-3.5 bg-surface-container border-none rounded-xl focus:ring-2 focus:ring-primary text-slate-900 placeholder:text-slate-400 font-medium"
            value={data.website}
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="space-y-1.5">
          ...
          <input
            className="w-full px-4 py-3 bg-surface-container border-none rounded-xl focus:ring-2 focus:ring-primary text-slate-900 placeholder:text-slate-400 font-medium text-sm"
            value={data.facebook}
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Djerba, Tunis…"
            />
          </div>
        </div>
        <div className="space-y-1.5">
          <label className="text-sm font-bold text-slate-700 ml-1">Région</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Médenine, Grand Tunis…"
            />
          </div>
        </div>
      </div>
      ...
      <div className="p-4 bg-primary/5 rounded-2xl border border-primary/20">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800 mb-1">Étape suivante : vos établissements</p>
            <p className="text-xs text-slate-500 font-medium">
              Après avoir complété votre profil, vous pourrez ajouter et gérer vos établissements touristiques depuis votre tableau de bord.
            </p>
          </div>
        </div>
      </div>
