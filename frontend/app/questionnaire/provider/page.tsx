...
const OWNER_PROFILES: Record<string, string> = {
  "Ambassadeur durable": "Propriétaire Ambassadeur",
  "Écovoyageur engagé": "Propriétaire Engagé",
  "Voyageur sensible": "Propriétaire Sensible",
  "Voyageur classique": "Propriétaire en Développement",
};
      ...
      <div className="min-h-screen bg-background flex flex-col">
        <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 py-4">
          <div className="max-w-2xl mx-auto flex items-center gap-2">
            ...
            <span className="text-lg font-extrabold tracking-tight">Évaluation Établissement</span>
          </div>
        </header>
