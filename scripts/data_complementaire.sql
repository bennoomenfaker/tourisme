...
INSERT INTO offers (id, author_id, author_type, project_id, category_id, title, description, price, duration, offer_type, images, inclusions, region, address, latitude, longitude, meeting_point, meeting_lat, meeting_lng, min_group_size, max_group_size, min_age, cancellation_policy, sustainability_score, confirmation_mode, status) VALUES
  ('55000000-0001-0000-0000-000000000013', '8148d448-9c88-4aa3-b2f1-7d71bc112f12', 'project_owner', '55000000-0001-0000-0000-000000000009', '21a655e0-de08-4b62-b0da-7c5337fd93be', 'Circuit Vélo Éco Hammamet', 'Cyclotourisme de 4h dans la région d''Hammamet. Parcours côtier et forêt, avec dégustation de produits bio locaux.', 40.00, '4h', 'activite', NULL, 'Vélo électrique, casque, guide, bouteille d''eau, dégustation', 'Hammamet', 'Avenue Bourguiba, Hammamet', 36.4020, 10.6300, 'Office de Tourisme', 36.4020, 10.6300, 2, 8, 12, 'Annulation gratuite 72h avant', 90, 'automatic', 'approved')
ON CONFLICT (id) DO NOTHING;
...
-- ============================================================================
INSERT INTO offers (id, author_id, author_type, project_id, category_id, title, description, price, duration, offer_type, images, inclusions, region, address, latitude, longitude, meeting_point, meeting_lat, meeting_lng, min_group_size, max_group_size, min_age, cancellation_policy, sustainability_score, confirmation_mode, status) VALUES
  ('55000000-0001-0000-0000-000000000015', '92a3ba7f-6bb3-4a57-bbb8-c70ff253a15e', 'project_owner', '55000000-0001-0000-0000-000000000011', 'e52ace62-a074-45e6-b3ee-b462aee4b03f', 'Chambre Troglodyte Matmata', 'Dormez dans une chambre creusée dans la roche traditionnelle. Expérience authentique berbère avec confort moderne et petit-déjeuner bio.', 85.00, '1 nuit', 'hebergement', NULL, 'Chambre privée, petit-déjeuner bio, visite guidée', 'Matmata', 'Route de Tataouine, Matmata', 33.5444, 9.9671, NULL, NULL, NULL, 1, 4, NULL, 'Annulation gratuite 24h avant', 92, 'automatic', 'approved')
ON CONFLICT (id) DO NOTHING;
