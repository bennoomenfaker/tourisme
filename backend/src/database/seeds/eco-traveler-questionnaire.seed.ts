...
const QUESTIONS = [
  {
    ...
    answers: [
      ...
      {
        text: 'Partager un trajet ou faire du covoiturage / hitchhike',
        score: 4,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Participer à une activité guidée avec un guide local',
        score: 4,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Respecter les règles et sensibiliser les autres visiteurs',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Faire tres attention et sensibiliser votre entourage',
        score: 4,
      },
    ],
  },
...
async function seed() {
  if (!process.env.DB_HOST || !process.env.DB_PASSWORD) {
    console.error(
      ' Variables .env manquantes. Vérifiez le chemin du fichier .env',
    );
    console.error('   DB_HOST:', process.env.DB_HOST);
    console.error(
      '   DB_PASSWORD:',
      process.env.DB_PASSWORD ? '***' : 'MANQUANT',
    );
    process.exit(1);
  }
  ...
  const questionnaire = await questionnaireRepo.save(
    questionnaireRepo.create({
      ...
      version: 1,
      description:
        'Imaginez que vous prenez une annee sabbatique pour decouvrir la Tunisie.',
