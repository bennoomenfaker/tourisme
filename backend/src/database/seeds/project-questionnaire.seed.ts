...
const QUESTIONS = [
  {
    ...
    answers: [
      ...
      {
        text: "Je m'approvisionne exclusivement chez des producteurs locaux certifiés",
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Zéro déchet : compostage, recyclage total, emballages réutilisables et sensibilisation clients',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "J'ai installé des équipements économes et suis ma consommation",
        score: 3,
      },
      {
        text: "J'utilise des énergies renouvelables (solaire) et ai un bilan carbone annuel",
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "J'emploie majoritairement du personnel local et participe à des événements communautaires",
        score: 3,
      },
      {
        text: 'Je co-gère avec la communauté, reverse une part des bénéfices et finance des projets sociaux locaux',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Récupération des eaux de pluie et limitation arrosage',
        score: 3,
      },
      {
        text: 'Système complet de recyclage des eaux grises, récupération pluie et sensibilisation des clients',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Une charte affichée dans mon établissement avec des actions concrètes',
        score: 3,
      },
      {
        text: 'Formation du personnel, charte clients, rapport de durabilité annuel publié',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Je propose des activités respectueuses et oriente vers des guides locaux',
        score: 3,
      },
      {
        text: 'Je participe activement à la préservation des sites et contribue aux fonds de protection',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Salaires valorisants, formations continues, participation aux bénéfices et couverture sociale complète',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: 'Je possède une ou plusieurs certifications et les renouvelle régulièrement',
        score: 4,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "Je publie un rapport d'impact annuel incluant données sociales, environnementales et économiques",
        score: 4,
      },
    ],
  },
...
async function seed() {
  ...
  console.log(
    `Seeded project questionnaire with ${QUESTIONS.length} questions`,
  );
  await dataSource.destroy();
}
