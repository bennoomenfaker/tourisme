...
export class InteractionsService {
  constructor(
    ...
    @InjectRepository(ProjectOwner)     private readonly ownerRepo: Repository<ProjectOwner>,
  ...
  private async assertTargetExists(type: string, targetId: string) {
    if (type === 'offer') {
      ...
      const p = await this.projectRepo.findOne({ where: { id: targetId, status: 'active' } });
